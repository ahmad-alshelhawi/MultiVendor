...
namespace AttarStore.Infrastructure.Migrations
{
    ...
    [Migration("20250505082704_init2")]
    partial class init2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttarStore.Domain.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "",
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 5, 8, 27, 3, 450, DateTimeKind.Unspecified).AddTicks(428), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "ahmad.al.shelhawi@gmail.com",
                            IsDeleted = false,
                            Name = "admin",
                            Password = "$2a$11$JFz3YSX.NuIWUp8EkBXhAOsWZkor1eOMt17iV9PGP4xpbPBTp.T2y",
                            Phone = "096654467",
                            Role = "Admin"
                        });
                });
