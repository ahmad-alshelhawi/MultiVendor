...
namespace AttarStore.Infrastructure.Migrations
{
    ...
    [Migration("20250505075810_init1")]
    partial class init1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttarStore.Domain.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "",
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 5, 7, 58, 9, 993, DateTimeKind.Unspecified).AddTicks(1038), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "ahmad.al.shelhawi@gmail.com",
                            IsDeleted = false,
                            Name = "admin",
                            Password = "$2a$11$zmbIkBatTA1GHJnl1vgHguU66qQ3vNjNG1cKOtpatj/cXgUsRhv1G",
                            Phone = "096654467",
                            Role = "Admin"
                        });
                });
