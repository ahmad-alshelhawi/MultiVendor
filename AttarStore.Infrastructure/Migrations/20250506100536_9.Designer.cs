            ...
            modelBuilder.Entity("AttarStore.Domain.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "",
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 6, 10, 5, 35, 931, DateTimeKind.Unspecified).AddTicks(8598), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "ahmad.al.shelhawi@gmail.com",
                            IsDeleted = false,
                            Name = "admin",
                            Password = "$2a$11$SZClOj.BVc1UO5FgXqfpLOqegEi2Itks61tdEoMsDlJvhFkO1dRw2",
                            Phone = "096654467",
                            Role = "Admin"
                        });
                });
