...
namespace AttarStore.Infrastructure.Migrations
{
    ...
    [Migration("20250504200409_init1")]
    partial class init1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttarStore.Domain.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "",
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 4, 20, 4, 8, 560, DateTimeKind.Unspecified).AddTicks(8597), new TimeSpan(0, 0, 0, 0, 0)),
